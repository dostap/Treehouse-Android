...
import daryao.com.rainy.weather.Current;
import daryao.com.rainy.weather.Day;
import daryao.com.rainy.weather.Forecast;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Current getCurrentDetails(String jsonData) throws JSONException {
        ...
        current.setHumdity(currently.getDouble("humidity"));
    ...
    private void updateDisplay() {
        ...
        mTempLabel.setText(String.valueOf(current.getTemperature()));
        mTimeLabel.setText("At " + current.getFormattedTime() + " it will be:");
        mHumidityValue.setText(String.valueOf(current.getHumdity())+"%");
